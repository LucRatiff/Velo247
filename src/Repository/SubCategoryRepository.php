...
class SubCategoryRepository extends ServiceEntityRepository
{
    ...
    /**
     * @param Category $category la catégorie qui contient les sous-catégories recherchées
     * @return SubCategory[] retourne un tableau de SubCategory dans l'ordre de position
     */
