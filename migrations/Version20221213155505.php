 ...
 */
final class Version20221213155505 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE message_gallery (id INT AUTO_INCREMENT NOT NULL, gallery_id INT DEFAULT NULL, user_id INT NOT NULL, date INT NOT NULL, last_edited INT DEFAULT NULL, content LONGTEXT NOT NULL, flagged INT NOT NULL, reactions LONGTEXT DEFAULT NULL, INDEX IDX_D7A342364E7AF8F (gallery_id), INDEX IDX_D7A34236A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE message_topic (id BIGINT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, topic_id INT DEFAULT NULL, date INT NOT NULL, last_edited INT DEFAULT NULL, flagged INT NOT NULL, content LONGTEXT NOT NULL, reactions LONGTEXT DEFAULT NULL, INDEX IDX_62E621F0A76ED395 (user_id), INDEX IDX_62E621F01F55203D (topic_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE sub_category (id INT AUTO_INCREMENT NOT NULL, category_id INT DEFAULT NULL, last_message_id BIGINT DEFAULT NULL, name VARCHAR(100) NOT NULL, position INT NOT NULL, description VARCHAR(255) DEFAULT NULL, messages_nb INT NOT NULL, topics_nb INT NOT NULL, INDEX IDX_BCE3F79812469DE2 (category_id), UNIQUE INDEX UNIQ_BCE3F798BA0E79C3 (last_message_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE topic (id INT AUTO_INCREMENT NOT NULL, sub_category_id INT NOT NULL, last_message_id BIGINT DEFAULT NULL, user_id INT NOT NULL, first_message_id BIGINT DEFAULT NULL, title VARCHAR(100) NOT NULL, slug VARCHAR(255) NOT NULL, messages_nb INT NOT NULL, locked TINYINT(1) NOT NULL, pinned TINYINT(1) NOT NULL, views_nb INT NOT NULL, date INT NOT NULL, INDEX IDX_9D40DE1BF7BFE87C (sub_category_id), UNIQUE INDEX UNIQ_9D40DE1BBA0E79C3 (last_message_id), INDEX IDX_9D40DE1BA76ED395 (user_id), INDEX IDX_9D40DE1BC2E2722E (first_message_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
